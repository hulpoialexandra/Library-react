      ...
      <IonRouterOutlet>
        <AuthProvider>
          ...
          <ItemProvider>
            ...
            <PrivateRoute path="/camera" component={PhotoGalleryScreen} exact={true} />
            <PrivateRoute path="/camera/:id" component={PhotoGalleryScreen} exact={true} />
            <PrivateRoute path="/map" component={MapScreen} exact={true} />
            <PrivateRoute path="/map/:id" component={MapScreen} exact={true} />
          </ItemProvider>
